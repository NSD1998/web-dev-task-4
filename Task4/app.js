...
let movies = [
    {
      ...
      image: "./Image/game-of-thrones slider.jpeg",
    ...
    {
      name: "No Way Home",
      des: "Peter Parker's secret identity is revealed to the entire world. Desperate for help, Peter turns to Doctor Strange to make the world forget that he is Spider-Man. The spell goes horribly wrong and shatters the multiverse, bringing in monstrous villains that could destroy the world.",
      image: "./Image/no way home.jpg",
    },
  ];
